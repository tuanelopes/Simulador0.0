...
!     
      ...
      if (optSolver=='umfpack') then
         call solverUMFPack(alhsD, brhsD, ApGeo, AiGeo, neqD, nalhsD)
      endif
      if (optSolver=='pardiso') then
         write(*,'(a)') '    |====> solver direto PARDISO, GEOMECHANICS'
...
!
      ...
      call readMaterialPropertiesDS(keyword_name, ierr)
!
...
#ifdef withumfpack
      optSolver='umfpack'
      simetriaVel=.false. ! 0 para não simetrico, unica versão disponivel para o UMFPACK
      simetriaGeo=.false. ! 0 para não simetrico, unica versão disponivel para o UMFPACK
#endif
#ifdef withpardiso
      optSolver='pardiso'
