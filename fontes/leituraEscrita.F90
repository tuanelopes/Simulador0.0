...
!
      ...
      call readStringKeywordValue(keyword_name, SPLITT, len(trim(SPLITT)), ierr)
...
!
      ...
      use mInputReader, only: readIntegerKeywordValue,readRealKeywordValue,findKeyword,genflDS
!
...
!
    ...
    subroutine readSetupPhaseDS
        ...
        use mGlobaisEscalares, only: nlvectP, nlvectV, nlvectD, exec, iprtin, optCC, TypeProcess
        ...
        call readStringKeywordValue(keyword_name, TypeProcess, len(trim(TypeProcess)), ierr)
!
        keyword_name = "title"
        call readStringKeywordValue(keyword_name, title, len(trim(title)), ierr)
!
        keyword_name = "exec"
