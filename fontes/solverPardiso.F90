...
! 
      real*8, allocatable  :: xGeo(:), xVel(:)
        ...
        if(label=='geo') then
           ...
           call solverPardisoPPD_Nodal(Ap, Ai, alhs, xGeo, b, neq, nonzeros, simetria, label,parte)
        else
           if(.not.allocated(xVel)) then
              allocate(xVel(neq))
              xVel=0.d0
           endif
           call solverPardisoPPD_Ladal(Ap, Ai, alhs, xVel, b, neq, nonzeros, simetria, label,parte)
        endif
#endif
...
!=======================================================================
!  
      subroutine solverPardisoPPD_Ladal(ia, ja, a, x, b, neq, nonzeros, simetria, label, parte)
...
! #endif
      ...
      end subroutine solverPardisoPPD_Ladal
!
!=======================================================================
!  
      subroutine solverPardisoPPD_Nodal(ia, ja, a, x, b, neq, nonzeros, simetria, label, parte)
